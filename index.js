...
createStyles(){
    ...
    link.href=`https://cdn.jsdelivr.net/gh/RodriguezJose92/start@latest/index.css`; /* custom this path */
            ...
            <div class="containerBtnsActions">
                ...
                <div id="containerQR" class="containerQRMudi" style="background-color:${this.color}">
                    ...
                    <div class="containerText">
                        ...
                        <div class="titleContainer">
                            <div class="iconTitle">
                                <img class="stepMudi step1" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/start@latest/assets/step3.webp">
                            </div>
                        ...
                        <div class="titleContainer">
                            <div class="iconTitle">
                                <img class="stepMudi step2" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/start@latest/assets/step4.webp">
                            </div>
                        ...
                        <div class="titleContainer">
                            <div class="iconTitle">
                                <img class="stepMudi step3" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/start@latest/assets/step2.webp">
                            </div>
                        ...
                        <div class="titleContainer">
                            <div class="iconTitle">
                                <img class="stepMudi step4" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/start@latest/assets/step1.webp">
                            </div>
...
setTimeout(() => {
    const skuElement = document.querySelector('meta[property="product:retailer_item_id"]');
    if (skuElement) {
        let sku = skuElement.getAttribute('content'); // Obtener el valor del atributo 'content'
        
        // Eliminar cualquier espacio o carácter no deseado
        sku = sku.trim(); // Usa .trim() para eliminar espacios al inicio y al final

        const container = document.querySelector('.vtex-flex-layout-0-x-flexColChild.vtex-flex-layout-0-x-flexColChild--product-image-container.pb0');
